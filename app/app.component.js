System.register(['angular2/core', 'angular2/http', 'rxjs/Rx', 'angular2/router', './products/product-list.component', './products/compare-car.component', './products/product.service', './twitch/stream.service', './home/welcome.component', './products/product-detail.component', './twitch/current-streams.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, router_1, product_list_component_1, compare_car_component_1, product_service_1, stream_service_1, welcome_component_1, product_detail_component_1, current_streams_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (current_streams_component_1_1) {
                current_streams_component_1 = current_streams_component_1_1;
            }],
        execute: function() {
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [product_service_1.ProductService, stream_service_1.StreamService, http_1.HTTP_PROVIDERS, router_1.ROUTER_PROVIDERS]
                    }),
                    router_1.RouteConfig([
                        ...
                        { path: '/streams', name: 'Streams', component: current_streams_component_1.CurrentStreamsComponent }
                    ]), 
